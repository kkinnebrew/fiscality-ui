...
},{"../templates/app.hbs":32,"../templates/app/settings.hbs":33,"../templates/home.hbs":34,"../templates/home/forgot.hbs":35,"../templates/home/login.hbs":36,"../templates/home/register.hbs":37,"../templates/home/reset.hbs":38,"./common/cache":2,"./common/router.coffee":5,"./viewmodels/app1/banking.coffee":13,"./viewmodels/app1/investments.coffee":14,"./viewmodels/app1/navigation.coffee":15,"./viewmodels/home/forgot.coffee":16,"./viewmodels/home/login.coffee":17,"./viewmodels/home/register.coffee":18,"./viewmodels/home/reset.coffee":19,"./views/app1/banking.jsx":20,"./views/app1/investments.jsx":26,"./views/app1/navigation.jsx":31,"datejs":"datejs","hbsfy/runtime":46,"jquery":"jquery","jquery-circle-progress":"jquery-circle-progress"}],2:[function(require,module,exports){
var cache = {};
  ...
  render: function() {
    return (
      React.createElement("div", {id: "banking"}, 
        React.createElement(BankingToolbar, {account: this.state.account, balance: this.state.balance, onClick: this.handleMenuClose, onAdd: this.handleAdd}), 
        React.createElement(PopupMenu, {ref: "addMenu", onSelect: this.handleAddSelect}), 
...
},{"./banking/menu.jsx":21,"./banking/popup-menu.jsx":22,"./banking/toolbar.jsx":23,"./banking/transaction-detail.jsx":24,"./banking/transaction-table.jsx":25,"react":"react"}],21:[function(require,module,exports){
var React = require('react');
var $ = require('jquery');
...
},{"./investments/chart.jsx":27,"./investments/holdings-table.jsx":28,"./investments/menu.jsx":29,"./investments/toolbar.jsx":30,"react":"react"}],27:[function(require,module,exports){
var React = require('react');
...
},{"jquery":"jquery","react":"react"}],30:[function(require,module,exports){
var React = require('react');
...
},{"hbsfy/runtime":46}],36:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":46}],37:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
