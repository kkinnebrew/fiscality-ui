...
var $, AuthService, Service, cache, transactionsAPI,
...
AuthService = (function(superClass) {
  ...
  AuthService.prototype.login = function(email, password) {
    ...
    success = function(user) {
      ...
      return transactionsAPI.accounts().then(function(data) {
        data.reverse();
        if (data && data.length > 0) {
          cache.setPersistentItem('accountId', data[0].accountId);
        }
...
},{"../common/cache":2,"../common/service":5,"./config":9,"./transactions.coffee":11,"jquery":"jquery"}],9:[function(require,module,exports){
module.exports = {
  BASE_URL: {
...
},{"./config":9,"jquery":"jquery","underscore":"underscore"}],11:[function(require,module,exports){
...
},{"../../../common/viewmodel":7,"../../../services/investments":10,"underscore":"underscore"}],17:[function(require,module,exports){
var investmentsAPI = require('../../../services/investments');
var ViewModel = require('../../../common/viewmodel');
var _ = require('underscore');
...
module.exports = SubNavViewModel;
},{"../../../common/viewmodel":7,"../../../services/investments":10,"underscore":"underscore"}],18:[function(require,module,exports){
var ViewModel = require('../../common/viewmodel');
var auth = require('../../services/auth.coffee');
