...
},{"../templates/app.hbs":34,"../templates/app/accounts.hbs":35,"../templates/app/accounts/chart.hbs":38,"../templates/app/accounts/connect.hbs":39,"../templates/app/accounts/overlay.hbs":41,"../templates/app/accounts/transactions.hbs":42,"../templates/app/investments.hbs":43,"../templates/app/investments/activity.hbs":44,"../templates/app/investments/allocation.hbs":45,"../templates/app/investments/overlay.hbs":46,"../templates/app/investments/performance.hbs":47,"../templates/app/investments/positions.hbs":48,"../templates/app/investments/positions/chart.hbs":49,"../templates/app/investments/positions/positions.hbs":50,"../templates/app/menu.hbs":51,"../templates/app/settings.hbs":52,"../templates/home.hbs":53,"../templates/home/forgot.hbs":54,"../templates/home/login.hbs":55,"../templates/home/register.hbs":56,"../templates/home/reset.hbs":57,"./common/cache":2,"./common/router.coffee":5,"./controllers/app/accounts/accounts.coffee":9,"./controllers/app/investments/investments.coffee":10,"./viewmodels/app/accounts/chart.coffee":15,"./viewmodels/app/accounts/connect.coffee":16,"./viewmodels/app/accounts/overlay.coffee":17,"./viewmodels/app/accounts/transactions.coffee":18,"./viewmodels/app/investments/investments.coffee":19,"./viewmodels/app/investments/overlay.coffee":20,"./viewmodels/app/investments/positions/chart.coffee":21,"./viewmodels/app/investments/positions/positions.coffee":22,"./viewmodels/app/menu.coffee":23,"./viewmodels/home/forgot.coffee":24,"./viewmodels/home/login.coffee":25,"./viewmodels/home/register.coffee":26,"./viewmodels/home/reset.coffee":27,"./views/app/accounts/chart.coffee":28,"./views/app/accounts/connect.coffee":29,"./views/app/accounts/overlay.coffee":30,"./views/app/accounts/transactions.coffee":31,"./views/app/investments/overlay.coffee":32,"./views/app/menu.coffee":33,"datejs":"datejs","hbsfy/runtime":65,"jquery":"jquery","jquery-circle-progress":"jquery-circle-progress"}],2:[function(require,module,exports){
var cache = {};
...
var $, TransactionsView, View, addLineTemplate, addTransactionTemplate, editorTemplate,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
TransactionsView = (function(superClass) {
  ...
  TransactionsView.prototype.bind = function() {
    ...
    this.$el.on('click', '.save-btn', function() {
      var row;
      row = $(this).closest('.transaction-group');
      row.find('.transaction-viewer').show();
      return row.find('.transaction-editor').remove();
    });
    return this.$el.on('click', '.insert-btn', function() {
      var accounts, currentDate, row;
      row = $(this).closest('.transaction-group');
      currentDate = row.find('[data-column="transactionDate"]').text();
      accounts = that.viewmodel.accounts;
      return $(addTransactionTemplate({
        accounts: accounts,
...
},{"../../../../templates/app/accounts/add-line.hbs":36,"../../../../templates/app/accounts/add-transaction.hbs":37,"../../../../templates/app/accounts/editor.hbs":40,"../../../common/view.coffee":7,"jquery":"jquery"}],32:[function(require,module,exports){
var $, OverlayView, View,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
},{"hbsfy/runtime":65}],35:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":65}],36:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
...
},{"hbsfy/runtime":65}],37:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
    var helper, alias1=helpers.helperMissing, alias2="function", alias3=this.escapeExpression;
...
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "\n        <div class=\"transaction-group\" data-key=\""
    ...
    + "\">\n\n            <div class=\"transaction-viewer\">\n\n                <div class=\"transaction-row list-row\">\n                    <div class=\"list-cell cell-sm\" data-column=\"transactionDate\">"
