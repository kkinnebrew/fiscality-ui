...
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<div class=\"transaction-list-body\" data-outlet></div>";
},"useData":true});
...
EditorComponent = (function(superClass) {
  ...
  EditorComponent.prototype.render = function() {
    ...
    return this.$el.on('click', '[data-model="accountNames"]', (function(_this) {
      return function() {
        return _this.$el.find('.line-editor').toggle();
      };
    })(this));
  };
...
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<div class=\"transaction-row\">\n\n    <div class=\"transaction-info\">\n        <div class=\"list-cell\">\n            <div data-component=\"date-field\" data-model=\"transactionDate\" data-format=\"M/d/yyyy\"></div>\n        </div>\n        <div class=\"list-cell\">\n            <div data-component=\"select-field\" data-model=\"transactionType\" data-source=\"transactionTypes\"></div>\n        </div>\n        <div class=\"list-cell\">\n            <div class=\"label-field\" data-model=\"accountNames\">Test</div>\n        </div>\n        <div class=\"list-cell\">\n            <div data-component=\"text-field\" data-model=\"description\"></div>\n        </div>\n        <div class=\"list-cell cell-right\">\n            <div class=\"label-field label-right\" data-model=\"amount\"></div>\n        </div>\n        <div class=\"list-cell cell-right\">\n            <div class=\"label-field label-right\">10,380.21</div>\n        </div>\n\n    </div>\n\n    <div data-component=\"line-editor\" data-model=\"otherLines\" data-repeat=\"editor-line\">Lines</div>\n\n</div>";
},"useData":true});
...
TransactionsView = (function(superClass) {
  ...
  TransactionsView.prototype.refresh = function() {
    ...
    component = new EditorListComponent(this.$el.find('.transaction-list-body'), this.viewmodel.transactions, this.viewmodel);
