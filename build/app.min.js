    ...
    _.each(config.views, (function(_this) {
      return function(conf, name) {
        ...
        if (!name.match(/@/)) {
          ...
          if (depth === 0) {
            $el = _this.$root.find(name != null ? name : '[ui-view="' + name + {
              '"]': '[ui-view]'
            });
          ...
          return Log.info('Rendering partial state: ' + state + ':' + name);
        }
      };
    })(this));
    ...
    _.each(config.views, (function(_this) {
      return function(conf, name) {
        ...
        if (name.match(/@/)) {
          ...
          return Log.info('Rendering absolute state: ' + state + ':' + name);
        }
      };
    })(this));
    if (config.presenter) {
      return node.presenter = config.presenter(params);
    }
  };

  Router.prototype.destroyState = function(depth) {
    return console.log('destroying state ' + depth);
  };
...
},{"../common/view":3,"./log.coffee":4,"./viewmodel.coffee":7,"jquery":"jquery","underscore":"underscore"}],7:[function(require,module,exports){
var ViewModel;
...
},{"../../../common1/presenter.coffee":5}],9:[function(require,module,exports){
...
},{"../../../common1/viewmodel.coffee":7}],11:[function(require,module,exports){
...
},{"../../../common1/viewmodel.coffee":7}],12:[function(require,module,exports){
...
},{"../../../common1/viewmodel.coffee":7}],13:[function(require,module,exports){
...
},{"../../../common1/viewmodel.coffee":7}],15:[function(require,module,exports){
...
},{"../../common1/viewmodel.coffee":7}],18:[function(require,module,exports){
module.exports = require('../../common1/viewmodel.coffee');



},{"../../common1/viewmodel.coffee":7}],19:[function(require,module,exports){
module.exports = require('../../common1/viewmodel.coffee');



},{"../../common1/viewmodel.coffee":7}],20:[function(require,module,exports){
module.exports = require('../../common1/viewmodel.coffee');



},{"../../common1/viewmodel.coffee":7}],21:[function(require,module,exports){
module.exports = require('../../common1/viewmodel.coffee');



},{"../../common1/viewmodel.coffee":7}],22:[function(require,module,exports){
...
},{"../../../common/view":3,"jquery":"jquery"}],23:[function(require,module,exports){
var $, MenuView, View,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
