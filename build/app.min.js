...
var CurrencyField = React.createClass({displayName: "CurrencyField",
  ...
  render: function() {
    ...
    return React.createElement("input", {className: this.props.className, type: "text", value: formatted, onChange: this.handleChange});
  }
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "transaction-row"}, 
        ...
        React.createElement(CurrencyField, {className: "column column-right", value: data.balance})
      )
    )
  }
