...
},{"../templates1/app.hbs":25,"../templates1/app/accounts.hbs":26,"../templates1/app/accounts/chart.hbs":27,"../templates1/app/accounts/overlay.hbs":28,"../templates1/app/accounts/transactions.hbs":29,"../templates1/app/investments.hbs":30,"../templates1/app/investments/activity.hbs":31,"../templates1/app/investments/allocation.hbs":32,"../templates1/app/investments/overlay.hbs":33,"../templates1/app/investments/performance.hbs":34,"../templates1/app/investments/positions.hbs":35,"../templates1/app/investments/positions/chart.hbs":36,"../templates1/app/investments/positions/positions.hbs":37,"../templates1/app/menu.hbs":38,"../templates1/app/settings.hbs":39,"../templates1/home.hbs":40,"../templates1/home/forgot.hbs":41,"../templates1/home/login.hbs":42,"../templates1/home/register.hbs":43,"../templates1/home/reset.hbs":44,"./common/cache":2,"./common1/router.coffee":6,"./presenters1/app/accounts/accounts.coffee":9,"./presenters1/app/investments/investments.coffee":10,"./viewmodels1/app/accounts/chart.coffee":11,"./viewmodels1/app/accounts/overlay.coffee":12,"./viewmodels1/app/accounts/transactions.coffee":13,"./viewmodels1/app/investments/investments.coffee":14,"./viewmodels1/app/investments/overlay.coffee":15,"./viewmodels1/app/investments/positions/chart.coffee":16,"./viewmodels1/app/investments/positions/positions.coffee":17,"./viewmodels1/app/menu.coffee":18,"./viewmodels1/home/forgot.coffee":19,"./viewmodels1/home/login.coffee":20,"./viewmodels1/home/register.coffee":21,"./viewmodels1/home/reset.coffee":22,"./views1/app/accounts/overlay.coffee":23,"./views1/app/menu.coffee":24,"datejs":"datejs","hbsfy/runtime":52,"jquery":"jquery","jquery-circle-progress":"jquery-circle-progress"}],2:[function(require,module,exports){
var cache = {};
    ...
    _.each(config.views, (function(_this) {
      return function(conf, name) {
        ...
        if (!name.match(/@/)) {
          ...
          subnode.view = typeof conf.view === 'function' ? new conf.view(conf.template) : new View(conf.template);
          if (depth === 0) {
...
},{"./log.coffee":4,"jquery":"jquery"}],8:[function(require,module,exports){
var ViewModel, _;
...
},{"../../../common1/viewmodel.coffee":8}],12:[function(require,module,exports){
var OverlayViewModel, ViewModel,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
},{"../../../common1/viewmodel.coffee":8}],13:[function(require,module,exports){
...
},{"../../../common1/viewmodel.coffee":8}],14:[function(require,module,exports){
...
},{"../../../common1/viewmodel.coffee":8}],15:[function(require,module,exports){
module.exports = require('../../../common1/viewmodel.coffee');



},{"../../../common1/viewmodel.coffee":8}],16:[function(require,module,exports){
module.exports = require('../../../../common1/viewmodel.coffee');



},{"../../../../common1/viewmodel.coffee":8}],17:[function(require,module,exports){
module.exports = require('../../../../common1/viewmodel.coffee');
...
},{"../../common1/viewmodel.coffee":8}],19:[function(require,module,exports){
module.exports = require('../../common1/viewmodel.coffee');
...
},{"../../../common/view":3,"jquery":"jquery"}],24:[function(require,module,exports){
var $, MenuView, View,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
},{"../../common1/view.coffee":7,"jquery":"jquery"}],25:[function(require,module,exports){
...
},{"hbsfy/runtime":52}],26:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":52}],27:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<h1 style=\"color: #F00\">Chart</h1>";
},"useData":true});

},{"hbsfy/runtime":52}],28:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<div id=\"accounts-overlay\">\n    <h1>Accounts</h1>\n    <a href=\"#/app/accounts/12312312\">My Account</a>\n</div>";
},"useData":true});

},{"hbsfy/runtime":52}],29:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":52}],30:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":52}],31:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":52}],32:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":52}],33:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<div id=\"portfolios-overlay\">\n    <h1>Portfolios</h1>\n    <a href=\"#/app/investments/12312321/positions\">My Account</a>\n</div>";
},"useData":true});

},{"hbsfy/runtime":52}],34:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":52}],35:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":52}],36:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<h3>Chart</h3>";
...
},{"hbsfy/runtime":52}],37:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"dup":41,"hbsfy/runtime":52}],43:[function(require,module,exports){
arguments[4][41][0].apply(exports,arguments)
},{"dup":41,"hbsfy/runtime":52}],44:[function(require,module,exports){
arguments[4][41][0].apply(exports,arguments)
},{"dup":41,"hbsfy/runtime":52}],45:[function(require,module,exports){
(function (global){
"use strict";
