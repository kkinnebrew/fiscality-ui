...
TransactionsView = (function(superClass) {
  ...
  function TransactionsView() {
    ...
    this.onSaveEdit = bind(this.onSaveEdit, this);
    this.onCancelEdit = bind(this.onCancelEdit, this);
    this.onDeleteLine = bind(this.onDeleteLine, this);
    this.onAddLine = bind(this.onAddLine, this);
    this.onDelete = bind(this.onDelete, this);
    this.onEdit = bind(this.onEdit, this);
    this.onDetail = bind(this.onDetail, this);
    return TransactionsView.__super__.constructor.apply(this, arguments);
  }

  TransactionsView.prototype.bindings = {
    '.detail-btn': {
      'click': 'onDetail'
    },
    '.edit-btn': {
  ...
  TransactionsView.prototype.onDetail = function(e) {
    var row;
  ...
  TransactionsView.prototype.onEdit = function(e) {
  ...
  TransactionsView.prototype.onDelete = function(e) {
    return $(e.currentTarget).closest('.transaction-group').remove();
  };

  TransactionsView.prototype.onAddLine = function(e) {
    var accounts, row;
  ...
  TransactionsView.prototype.onDeleteLine = function(e) {
    var lines;
    lines = $(e.currentTarget).closest('.transaction-editor').find('.line-row');
    if (lines.length > 1) {
      return $(e.currentTarget).closest('.line-row').remove();
    }
  };

  TransactionsView.prototype.onCancelEdit = function(e) {
    var row;
    row = $(e.currentTarget).closest('.transaction-group');
  ...
  TransactionsView.prototype.onSaveEdit = function(e) {
    var row;
    row = $(e.currentTarget).closest('.transaction-group');
    row.find('.transaction-viewer').show();
    return row.find('.transaction-editor').remove();
  ...
  TransactionsView.prototype.onInsert = function(e) {
