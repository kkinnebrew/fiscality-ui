  ...
  render: function() {
    return (
      React.createElement("div", {id: "banking"}, 
        ...
        React.createElement(TransactionTable, {key: "transaction-table", transactions: this.state.transactions, onCancel: this.handleCancel, onSave: this.handleSave, onEdit: this.handleEdit}), 
    ...
    return (
      React.createElement("div", {className: "row editing", "data-key": transaction.transactionId}, 
        ...
        React.createElement("div", {className: "column md"}, 
          React.createElement(SelectField, {className: "field", ref: "type", value: transaction.transactionType})
        ), 
  ...
  render: function() {
    ...
    var transactionRows = this.props.transactions.map(function(transaction) {
      if (transaction.editing) {
        return (
          React.createElement(TransactionEditRow, {transaction: transaction, onSave: that.handleSave, onCancel: that.handleCancel, key: transaction.transactionId})
        )
      } else {
        return (
...
var CurrencyField = React.createClass({displayName: "CurrencyField",
  ...
  render: function() {
    ...
    if (this.props.editable == 'true') {
      return React.createElement("input", {className: classes, type: "text", value: formatted, onChange: this.handleChange});
    } else {
