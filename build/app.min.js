...
},{"../templates/app.hbs":43,"../templates/app/accounts.hbs":44,"../templates/app/accounts/connect.hbs":45,"../templates/app/accounts/overlay.hbs":46,"../templates/app/investments.hbs":47,"../templates/app/investments/activity.hbs":48,"../templates/app/investments/allocation.hbs":49,"../templates/app/investments/overlay.hbs":50,"../templates/app/investments/performance.hbs":51,"../templates/app/investments/positions.hbs":52,"../templates/app/investments/positions/chart.hbs":53,"../templates/app/investments/positions/positions.hbs":54,"../templates/app/menu.hbs":55,"../templates/app/settings.hbs":56,"../templates/home.hbs":57,"../templates/home/forgot.hbs":58,"../templates/home/login.hbs":59,"../templates/home/register.hbs":60,"../templates/home/reset.hbs":61,"./common/cache":2,"./common/router.coffee":6,"./controllers/app/accounts/accounts.coffee":10,"./controllers/app/investments/investments.coffee":11,"./viewmodels/app/accounts/account.coffee":16,"./viewmodels/app/accounts/connect.coffee":17,"./viewmodels/app/accounts/overlay.coffee":18,"./viewmodels/app/accounts/transactions.coffee":19,"./viewmodels/app/investments/investments.coffee":20,"./viewmodels/app/investments/overlay.coffee":21,"./viewmodels/app/investments/positions/chart.coffee":22,"./viewmodels/app/investments/positions/positions.coffee":23,"./viewmodels/app/menu.coffee":24,"./viewmodels/home/forgot.coffee":25,"./viewmodels/home/login.coffee":26,"./viewmodels/home/register.coffee":27,"./viewmodels/home/reset.coffee":28,"./views/app/accounts/account.jsx":29,"./views/app/accounts/connect.coffee":30,"./views/app/accounts/overlay.coffee":31,"./views/app/accounts/transactions.jsx":32,"./views/app/investments/overlay.coffee":41,"./views/app/menu.coffee":42,"datejs":"datejs","hbsfy/runtime":69,"jquery":"jquery","jquery-circle-progress":"jquery-circle-progress"}],2:[function(require,module,exports){
var cache = {};
...
},{"./log.coffee":4,"jquery":"jquery","react":"react","underscore":"underscore"}],6:[function(require,module,exports){
...
},{"./log.coffee":4,"./react-view.coffee":5,"./view.coffee":8,"./viewmodel.coffee":9,"jquery":"jquery","underscore":"underscore"}],7:[function(require,module,exports){
var $ = require('jquery');
...
},{"./log.coffee":4,"jquery":"jquery","underscore":"underscore"}],9:[function(require,module,exports){
var Log, ViewModel, _;
...
},{"./log.coffee":4,"underscore":"underscore"}],10:[function(require,module,exports){
...
},{"../../../common/controller.coffee":3}],11:[function(require,module,exports){
...
},{"../../../common/controller.coffee":3}],12:[function(require,module,exports){
...
},{"../common/cache":2,"../common/service":7,"./config":13,"./investments.coffee":14,"./transactions.coffee":15,"jquery":"jquery"}],13:[function(require,module,exports){
module.exports = {
  BASE_URL: {
...
},{"../common/cache":2,"../common/service":7,"./config":13,"jquery":"jquery","underscore":"underscore"}],15:[function(require,module,exports){
...
},{"../common/cache":2,"../common/service":7,"./config":13,"jquery":"jquery","underscore":"underscore"}],16:[function(require,module,exports){
var $, AccountViewModel, Log, ViewModel, cache, numberWithCommas, transactionsService,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
AccountViewModel = (function(superClass) {
  extend(AccountViewModel, superClass);

  function AccountViewModel(params) {
    AccountViewModel.__super__.constructor.apply(this, arguments);
    this.accountId = params.accountId || null;
    this.account = null;
    this.balance = 0;
    this.update();
  ...
  AccountViewModel.prototype.update = function() {
    ...
    return $.when(accountRequest, balanceRequest).then((function(_this) {
      return function(account, balance) {
        ...
        _this.balance = !isNaN(balance) ? numberWithCommas(balance.toFixed(2)) : 0;
      ...
      return function() {
        _this.stopLoading();
        return Log.error('Error loading account for accountId: ' + _this.accountId);
      };
    })(this));
  };

  AccountViewModel.prototype.choose = function() {
    return this.fire('choose');
  };

  AccountViewModel.prototype.setAccount = function(accountId) {
...
},{"../../../common/cache":2,"../../../common/log.coffee":4,"../../../common/viewmodel.coffee":9,"../../../services/transactions.coffee":15,"jquery":"jquery"}],17:[function(require,module,exports){
...
},{"../../../common/log.coffee":4,"../../../common/viewmodel.coffee":9,"../../../services/transactions.coffee":15}],18:[function(require,module,exports){
...
},{"../../../common/log.coffee":4,"../../../common/viewmodel.coffee":9,"../../../services/transactions.coffee":15}],19:[function(require,module,exports){
...
TransactionsViewModel = (function(superClass) {
  ...
  TransactionsViewModel.prototype.update = function() {
    ...
    return $.when(transactionsRequest).then((function(_this) {
      return function(transactions) {
        _this.transactions = _.sortBy(_.map(transactions, map), 'date').reverse();
        return _this.fire('refresh', {
  ...
  TransactionsViewModel.prototype.sortBy = function(column) {
    this.transactions = _.sortBy(this.transactions, column);
    this.sort = column;
...
},{"../../../common/log.coffee":4,"../../../common/viewmodel.coffee":9,"../../../services/transactions.coffee":15,"jquery":"jquery","underscore":"underscore"}],20:[function(require,module,exports){
...
},{"../../../common/log.coffee":4,"../../../common/viewmodel.coffee":9,"../../../services/investments.coffee":14}],21:[function(require,module,exports){
...
},{"../../../common/log.coffee":4,"../../../common/viewmodel.coffee":9,"../../../services/investments.coffee":14}],22:[function(require,module,exports){
module.exports = require('../../../../common/viewmodel.coffee');



},{"../../../../common/viewmodel.coffee":9}],23:[function(require,module,exports){
module.exports = require('../../../../common/viewmodel.coffee');



},{"../../../../common/viewmodel.coffee":9}],24:[function(require,module,exports){
...
},{"../../common/viewmodel.coffee":9}],25:[function(require,module,exports){
...
},{"../../common/log.coffee":4,"../../common/viewmodel.coffee":9,"../../services/auth.coffee":12}],26:[function(require,module,exports){
...
},{"../../common/log.coffee":4,"../../common/viewmodel.coffee":9,"../../services/auth.coffee":12}],27:[function(require,module,exports){
...
},{"../../common/log.coffee":4,"../../common/viewmodel.coffee":9,"../../services/auth.coffee":12}],28:[function(require,module,exports){
...
},{"../../common/log.coffee":4,"../../common/viewmodel.coffee":9,"../../services/auth.coffee":12}],29:[function(require,module,exports){
    ...
    return (
      React.createElement("div", {className: "account-panel"}, 
        React.createElement("div", {className: "account-header"}, 
          React.createElement("div", {className: "menu-button", onClick: this.handleMenu}), 
          React.createElement("div", {className: "account-info"}, 
            React.createElement("div", {className: "account-name"}, this.state.account.name), 
            React.createElement("div", {className: "account-type"}, this.state.account.type)
          ), 
          React.createElement("div", {className: "account-balance"}, 
            React.createElement("div", {className: "amount"}, this.state.balance), 
            React.createElement("div", {className: "label"}, "Balance (USD)")
          )
        ), 
        React.createElement("div", {className: "nav"}, 
          React.createElement("div", {className: "nav-button transactions-button", "data-tab": "transactions", onClick: this.handleClick}, "Transactions"), 
          React.createElement("div", {className: "nav-button performance-button", "data-tab": "performance", onClick: this.handleClick}, "Performance"), 
          React.createElement("div", {className: "nav-button nav-button-right settings-button", "data-tab": "settings", onClick: this.handleClick}, "Settings")
        )
      )
    )
...
},{"react":"react","underscore":"underscore"}],30:[function(require,module,exports){
...
},{"../../../common/view.coffee":8,"jquery":"jquery"}],31:[function(require,module,exports){
...
},{"../../../common/view.coffee":8,"jquery":"jquery"}],32:[function(require,module,exports){
var React = require('react');
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "transactions"}, 
        ...
        React.createElement(TransactionsBody, {sort: this.state.sort, data: this.state.transactions})
      )
    )
...
},{"./transactions/transactions-body.jsx":39,"./transactions/transactions-header.jsx":40,"react":"react","underscore":"underscore"}],33:[function(require,module,exports){
var React = require('react');
...
var CurrencyField = React.createClass({displayName: "CurrencyField",
  ...
  render: function() {
    ...
    if (this.props.editable == 'true') {
      ...
      return React.createElement("div", {className: classes}, formatted);
    }
  }
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: classes}, 
        React.createElement(DateField, {className: "column", value: data.date, onBlur: this.handleBlur, onFocus: this.handleFocus, onChange: this.handleChange}), 
        React.createElement(SelectField, {className: "column", value: data.transactionType, onBlur: this.handleBlur, onFocus: this.handleFocus, onChange: this.handleChange}), 
        React.createElement(TextField, {className: "column", value: data.description, onBlur: this.handleBlur, onFocus: this.handleFocus, onChange: this.handleChange}), 
        React.createElement(CurrencyField, {className: "column column-right column-last", value: data.balance, editable: "false"}), 
        React.createElement(CurrencyField, {className: "column column-right", value: data.amount, onFocus: this.handleFocus, onBlur: this.handleBlur, onChange: this.handleChange})
      )
    )
  }
...
},{"./currency-field.jsx":33,"./date-field.jsx":34,"./label.jsx":35,"./select-field.jsx":36,"./text-field.jsx":37,"react":"react"}],39:[function(require,module,exports){
var React = require('react');
...
var TransactionsTable = React.createClass({displayName: "TransactionsTable",
  ...
  render: function() {
    ...
    var transactionRows = this.props.data.map(function(transaction) {
      return (
        React.createElement(TransactionRow, {data: transaction, onSelect: this.handleSelect})
      )
    });

    return (
      React.createElement("div", {className: "transactions-body"}, 
          transactionRows
      )
    )
...
},{"./transaction-row.jsx":38,"react":"react","underscore":"underscore"}],40:[function(require,module,exports){
var React = require('react');
var $ = require('jquery');
var _ = require('underscore');
    ...
    var cells = _.map(columns, function(label, column) {
      ...
      if (that.props.sort == column) {
        if (that.props.direction == 'desc') {
          classes += ' active desc';
          return React.createElement("div", {className: classes, onClick: that.handleClick, "data-column": column}, label);
        } else {
          classes += ' active asc';
          return React.createElement("div", {className: classes, onClick: that.handleClick, "data-column": column}, label);
        }
...
},{"jquery":"jquery","react":"react","underscore":"underscore"}],41:[function(require,module,exports){
var $, OverlayView, View,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
},{"../../../common/view.coffee":8,"jquery":"jquery"}],42:[function(require,module,exports){
var $, MenuView, View,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
},{"../../common/view.coffee":8,"jquery":"jquery"}],43:[function(require,module,exports){
...
},{"hbsfy/runtime":69}],44:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":69}],45:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":69}],46:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
...
},{"hbsfy/runtime":69}],47:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":69}],48:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":69}],49:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":69}],50:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
    return "        <div class=\"close-btn\" data-bind=\"click:close()\"></div>\n";
...
},{"hbsfy/runtime":69}],51:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":69}],52:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":69}],53:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    var stack1, alias1=this.escapeExpression;
...
},{"hbsfy/runtime":69}],54:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":69}],55:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":69}],56:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":69}],57:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":69}],58:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":69}],59:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":69}],60:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":69}],61:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":69}],62:[function(require,module,exports){
(function (global){
"use strict";
