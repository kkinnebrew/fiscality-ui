...
window.App = router;
},{"../templates/app.hbs":27,"../templates/app/accounts/chart.hbs":28,"../templates/app/accounts/content.hbs":29,"../templates/app/accounts/subnav.hbs":30,"../templates/app/accounts/transactions.hbs":31,"../templates/app/investments/content.hbs":32,"../templates/app/investments/subnav.hbs":33,"../templates/home.hbs":34,"../templates/home/forgot.html":35,"../templates/home/login.html":36,"../templates/home/register.html":37,"../templates/home/reset.html":38,"./common/cache":2,"./common/router":4,"./viewmodels/app":12,"./viewmodels/app/accounts/chart":13,"./viewmodels/app/accounts/subnav":14,"./viewmodels/app/accounts/transactions":15,"./viewmodels/app/investments/holdings":16,"./viewmodels/app/investments/subnav":17,"./viewmodels/home/forgot":18,"./viewmodels/home/login":19,"./viewmodels/home/register":20,"./viewmodels/home/reset":21,"./views/app.js":22,"./views/app/accounts/chart.coffee":23,"./views/app/accounts/subnav.coffee":24,"./views/app/accounts/transactions.coffee":25,"./views/app/investments/subnav":26,"datejs":"datejs","hbsfy/runtime":46,"jquery":"jquery","jquery-circle-progress":"jquery-circle-progress"}],2:[function(require,module,exports){
var cache = {};
...
},{"../../../common/cache":2,"../../../common/viewmodel":7,"../../../services/transactions.coffee":11,"jquery":"jquery","underscore":"underscore"}],14:[function(require,module,exports){
var transactionsAPI = require('../../../services/transactions.coffee');
var ViewModel = require('../../../common/viewmodel');
var _ = require('underscore');
...
},{"../../../common/viewmodel":7,"../../../services/transactions.coffee":11,"underscore":"underscore"}],15:[function(require,module,exports){
var transactionsAPI = require('../../../services/transactions.coffee');
var ViewModel = require('../../../common/viewmodel');
var _ = require('underscore');
...
},{"../../../common/viewmodel":7,"../../../services/investments.coffee":10,"underscore":"underscore"}],17:[function(require,module,exports){
var investmentsAPI = require('../../../services/investments.coffee');
var ViewModel = require('../../../common/viewmodel');
var _ = require('underscore');
...
module.exports = SubNavViewModel;
},{"../../../common/viewmodel":7,"../../../services/investments.coffee":10,"underscore":"underscore"}],18:[function(require,module,exports){
var ViewModel = require('../../common/viewmodel');
var auth = require('../../services/auth.coffee');
...
},{"../../common/viewmodel":7,"../../services/auth.coffee":8}],22:[function(require,module,exports){
...
ChartView = (function(superClass) {
  ...
  ChartView.prototype.setup = function() {
    this.viewModel.on('prefresh', this.startLoading);
    return this.viewModel.on('refresh', this.stopLoading);
  };

  ChartView.prototype.bind = function() {
    var that;
    that = this;
    return that.$el.on('click', '.range-picker-item', function() {
...
SubNavView = (function(superClass) {
  ...
  SubNavView.prototype.render = function() {
    SubNavView.__super__.render.apply(this, arguments);
    return this.startLoading();
  };
  ...
  SubNavView.prototype.startLoading = function() {
    ...
    this.loading = true;
    return this.$el.find('.progress').show().circleProgress({
      value: 1,
      size: 24,
      thickness: 3,
      fill: {
...
},{"../../../common/view":6,"jquery":"jquery"}],25:[function(require,module,exports){
...
TransactionsView = (function(superClass) {
  ...
  TransactionsView.prototype.load = function() {
    this.viewModel.on('prefresh', this.startLoading);
    return this.viewModel.on('refresh', this.stopLoading);
  };
...
},{"../../../common/view":6,"jquery":"jquery"}],26:[function(require,module,exports){
var View = require('../../../common/view');
var $ = require('jquery');
...
},{"../../../common/view":6,"jquery":"jquery"}],27:[function(require,module,exports){
...
},{"hbsfy/runtime":46}],29:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "\n    <li class=\"sub-nav-item\" data-link=\"/app/accounts/"
    ...
    return "\n<div class=\"no-account-splash\">\n\n    <div class=\"splash-icon\"></div>\n\n    <div class=\"splash-label\">Connect Accounts</div>\n\n</div>\n\n";
},"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    var stack1;
  ...
  return "<ul class=\"sub-nav\">\n\n    <li class=\"sub-nav-header\">\n        <div class=\"sub-nav-title\">Accounts</div>\n        <div class=\"sub-nav-button\"></div>\n    </li>\n\n"
    ...
    + "\n</ul>\n\n<div class=\"progress\"></div>\n\n"
    + ((stack1 = helpers.unless.call(depth0,(depth0 != null ? depth0.accounts : depth0),{"name":"unless","hash":{},"fn":this.program(3, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "");
},"useData":true});
...
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "\n    <div class=\"holdings-row\">\n        <div class=\"holdings-column column-xsm column-left\">"
    ...
    + "</div>\n        <div class=\"holdings-column column-sm column-left\">"
    + alias2(((helper = (helper = helpers.dayPercentageChange || (depth0 != null ? depth0.dayPercentageChange : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(depth0,{"name":"dayPercentageChange","hash":{},"data":data}) : helper)))
    + "%</div>\n        <div class=\"holdings-column column-sm column-left\">"
    + alias2(((helper = (helper = helpers.unrealizedQuantity || (depth0 != null ? depth0.unrealizedQuantity : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(depth0,{"name":"unrealizedQuantity","hash":{},"data":data}) : helper)))
    + "</div>\n        <div class=\"holdings-column column-sm column-left\">"
  ...
  return "<h2 style=\"color: #F00\">My Portfolio "
    + this.escapeExpression(((helper = (helper = helpers.portfolioId || (depth0 != null ? depth0.portfolioId : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0,{"name":"portfolioId","hash":{},"data":data}) : helper)))
    + "</h2>\n\n<div>\n\n"
...
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "\n        <li class=\"sub-nav-item"
    + ((stack1 = helpers['if'].call(depth0,((stack1 = (data && data.root)) && stack1.portfolioId),{"name":"if","hash":{},"fn":this.program(2, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "\" data-link=\"/app/investments/"
  ...
  return "<ul class=\"sub-nav\">\n\n    <li class=\"sub-nav-header\">\n        <div class=\"sub-nav-title\">Portfolios</div>\n        <div class=\"sub-nav-button\"></div>\n    </li>\n\n"
