...
},{"./config":7,"./transactions":8,"jquery":"jquery"}],7:[function(require,module,exports){
module.exports = {
  BASE_URL: {
...
ChartView = (function(superClass) {
  ...
  ChartView.prototype.bind = function() {
    var that;
    that = this;
    return that.$el.on('click', '.range-picker-item', (function(_this) {
      return function() {
