...
},{"../templates/app.hbs":34,"../templates/app/accounts.hbs":35,"../templates/app/accounts/chart.hbs":36,"../templates/app/accounts/connect.hbs":37,"../templates/app/accounts/overlay.hbs":38,"../templates/app/accounts/transactions.hbs":39,"../templates/app/investments.hbs":40,"../templates/app/investments/activity.hbs":41,"../templates/app/investments/allocation.hbs":42,"../templates/app/investments/overlay.hbs":43,"../templates/app/investments/performance.hbs":44,"../templates/app/investments/positions.hbs":45,"../templates/app/investments/positions/chart.hbs":46,"../templates/app/investments/positions/positions.hbs":47,"../templates/app/menu.hbs":48,"../templates/app/settings.hbs":49,"../templates/home.hbs":50,"../templates/home/forgot.hbs":51,"../templates/home/login.hbs":52,"../templates/home/register.hbs":53,"../templates/home/reset.hbs":54,"./common/cache":2,"./common/router.coffee":5,"./presenters/app/accounts/accounts.coffee":9,"./presenters/app/investments/investments.coffee":10,"./viewmodels/app/accounts/chart.coffee":15,"./viewmodels/app/accounts/connect.coffee":16,"./viewmodels/app/accounts/overlay.coffee":17,"./viewmodels/app/accounts/transactions.coffee":18,"./viewmodels/app/investments/investments.coffee":19,"./viewmodels/app/investments/overlay.coffee":20,"./viewmodels/app/investments/positions/chart.coffee":21,"./viewmodels/app/investments/positions/positions.coffee":22,"./viewmodels/app/menu.coffee":23,"./viewmodels/home/forgot.coffee":24,"./viewmodels/home/login.coffee":25,"./viewmodels/home/register.coffee":26,"./viewmodels/home/reset.coffee":27,"./views/app/accounts/chart.coffee":28,"./views/app/accounts/connect.coffee":29,"./views/app/accounts/overlay.coffee":30,"./views/app/accounts/transactions.coffee":31,"./views/app/investments/overlay.coffee":32,"./views/app/menu.coffee":33,"datejs":"datejs","hbsfy/runtime":62,"jquery":"jquery","jquery-circle-progress":"jquery-circle-progress"}],2:[function(require,module,exports){
var cache = {};
...
Presenter = (function() {
  ...
  Presenter.prototype.setParams = function(params, ignore) {
    var changed;
    changed = false;
    ...
    while (parts.length) {
      ...
      if (!this.stack[depth] || this.stack[depth].state !== state) {
        ...
        if (this.stack[depth].presenter) {
          this.stack[depth].presenter.setParams(params, true);
...
AccountsPresenter = (function(superClass) {
  ...
  AccountsPresenter.prototype.showConnectAccount = function() {
  ...
  AccountsPresenter.prototype.hideConnectAccount = function() {
    console.log('hiding');
  ...
  AccountsPresenter.prototype.doneConnecting = function() {
...
ConnectAccountViewModel = (function(superClass) {
  ...
  ConnectAccountViewModel.prototype.create = function(accountName, accountType) {
    console.log('creating account', accountName, accountType);
    ...
    return transactionsService.createAccount(accountName, accountType).then((function(_this) {
      ...
      return function() {
        return console.log('error creating account');
      };
    })(this));
  };
...
},{"../../../common/log.coffee":3,"../../../common/viewmodel.coffee":8,"../../../services/transactions.coffee":14}],18:[function(require,module,exports){
...
},{"../../../common/log.coffee":3,"../../../common/viewmodel.coffee":8,"../../../services/transactions.coffee":14,"underscore":"underscore"}],19:[function(require,module,exports){
...
},{"../../../common/log.coffee":3,"../../../common/viewmodel.coffee":8,"../../../services/investments.coffee":13}],21:[function(require,module,exports){
...
},{"../../common/log.coffee":3,"../../common/viewmodel.coffee":8,"../../services/auth.coffee":11}],28:[function(require,module,exports){
...
},{"hbsfy/runtime":62}],35:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":62}],37:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":62}],38:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
...
},{"hbsfy/runtime":62}],40:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    var stack1, alias1=this.escapeExpression;
...
},{"hbsfy/runtime":62}],41:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":62}],42:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":62}],43:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
    return "        <div class=\"close-btn\" data-bind=\"click:close()\"></div>\n";
...
},{"hbsfy/runtime":62}],44:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":62}],45:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":62}],46:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    var stack1, alias1=this.escapeExpression;
...
},{"hbsfy/runtime":62}],47:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":62}],48:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":62}],49:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":62}],50:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":62}],51:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":62}],52:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":62}],53:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":62}],54:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":62}],55:[function(require,module,exports){
(function (global){
"use strict";
...
},{"./handlebars/base":56,"./handlebars/exception":57,"./handlebars/runtime":58,"./handlebars/safe-string":59,"./handlebars/utils":60}],56:[function(require,module,exports){
"use strict";
...
},{"./exception":57,"./utils":60}],57:[function(require,module,exports){
"use strict";
...
},{"./base":56,"./exception":57,"./utils":60}],59:[function(require,module,exports){
"use strict";
...
},{"./dist/cjs/handlebars.runtime":55}],62:[function(require,module,exports){
module.exports = require("handlebars/runtime")["default"];

},{"handlebars/runtime":61}]},{},[1])
