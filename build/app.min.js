...
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<div class=\"editor-line\">\n\n    <div data-component=\"select-field\" data-model=\"accountId\" data-source=\"accountOptions\">1</div>\n    <div data-component=\"text-field\" data-model=\"amount\">2</div>\n    <div>Delete</div>\n\n</div>";
},"useData":true});
...
ListComponent = (function() {
  ...
  ListComponent.prototype.render = function() {
    var $appendTo, $template, name, self;
    self = this;
    $template = $(this.getTemplate());
    $appendTo = $template.find('[data-outlet]').length ? $template.find('[data-outlet]') : $template;
    ...
    _.each(this.model, function(line, index) {
      ...
      return $appendTo.append(component.$el);
    });
...
TransactionsView = (function(superClass) {
  ...
  TransactionsView.prototype.refresh = function() {
    ...
    component = new EditorListComponent(this.$el.find('#editor-list'), this.viewmodel.transactions, this.viewmodel);
