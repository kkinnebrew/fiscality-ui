...
},{"../templates/app.hbs":27,"../templates/app/settings.hbs":28,"../templates/home.hbs":29,"../templates/home/forgot.hbs":30,"../templates/home/login.hbs":31,"../templates/home/register.hbs":32,"../templates/home/reset.hbs":33,"./common/cache":2,"./common/router.coffee":5,"./viewmodels/app1/navigation.coffee":13,"./viewmodels/home/forgot.coffee":14,"./viewmodels/home/login.coffee":15,"./viewmodels/home/register.coffee":16,"./viewmodels/home/reset.coffee":17,"./views/app1/banking.jsx":18,"./views/app1/investments.jsx":22,"./views/app1/navigation.jsx":26,"datejs":"datejs","hbsfy/runtime":41,"jquery":"jquery","jquery-circle-progress":"jquery-circle-progress"}],2:[function(require,module,exports){
var cache = {};
...
},{"../../common/viewmodel.coffee":8}],14:[function(require,module,exports){
...
},{"../../common/log.coffee":3,"../../common/viewmodel.coffee":8,"../../services/auth.coffee":9}],15:[function(require,module,exports){
...
},{"../../common/log.coffee":3,"../../common/viewmodel.coffee":8,"../../services/auth.coffee":9}],16:[function(require,module,exports){
  ...
  render: function() {
    return (
      React.createElement("div", {id: "banking"}, 
        React.createElement(BankingToolbar, null), 
        React.createElement(TransactionTable, null), 
        React.createElement(TransactionDetail, null)
      )
    )
  }
...
},{"./banking/toolbar.jsx":19,"./banking/transaction-detail.jsx":20,"./banking/transaction-table.jsx":21,"react":"react"}],19:[function(require,module,exports){
var React = require('react');
  ...
  render: function() {
    return (
      React.createElement("div", {className: "toolbar"}, 
        ...
        React.createElement("h2", {className: "label"}), 
        React.createElement("div", {className: "info"}, 
          React.createElement("div", {className: "balance"}), 
          React.createElement("div", {className: "updated"})
        ), 
        React.createElement("div", {className: "add-transaction-button"})
      )
    )
  }
    ...
    return (
      React.createElement("div", {id: "transaction-detail"}, 
        React.createElement("div", {className: "actions"}, 
          React.createElement("div", {className: "modify-button"}, "Modify"), 
      ...
      React.createElement("div", {id: "transaction-table"}, 
        React.createElement("thead", null, 
          React.createElement("tr", {className: "header-row"}, 
            React.createElement("th", {className: "header-column selected ascending"}, "Date"), 
            React.createElement("th", {className: "header-column"}, "Type"), 
            React.createElement("th", {className: "header-column"}, "Description"), 
            React.createElement("th", {className: "header-column"}, "Amount"), 
            React.createElement("th", {className: "header-column"}, "Balance")
          )
        ), 
        React.createElement("tbody", null, 
          React.createElement("tr", {className: "row"}, 
            React.createElement("td", {className: "column"}, 
              React.createElement("div", {className: "label"}, "8/19/2014")
              ), 
            React.createElement("td", {className: "column"}, 
              React.createElement("div", {className: "label"}, "Paycheck Deposit")
            ), 
            React.createElement("td", {className: "column"}, 
              React.createElement("div", {className: "label"}, "Web Design Agency"), 
              React.createElement("div", {className: "tag"}, "Interest"), 
              React.createElement("div", {className: "tag"}, "Taxable\"")
            ), 
            React.createElement("td", {className: "column"}, 
              React.createElement("div", {className: "label"}, "1,503.21")
            ), 
            React.createElement("td", {className: "column"}, 
              React.createElement("div", {className: "label"}, "$3,912.61")
            )
          )
        )
      )
  ...
  render: function() {
    return (
      React.createElement("div", {id: "investments"}, 
        React.createElement(InvestmentsToolbar, null), 
        React.createElement(InvestmentsChart, null), 
        React.createElement(HoldingsTable, null)
      )
    )
  }
...
},{"./investments/chart.jsx":23,"./investments/holdings-table.jsx":24,"./investments/toolbar.jsx":25,"react":"react"}],23:[function(require,module,exports){
var React = require('react');
      ...
      React.createElement("div", {id: "investments-chart"}, 
        React.createElement("div", {className: "controls"}, 
          React.createElement("ul", {className: "views"}, 
            React.createElement("li", {className: "view-option"}, "Performance"), 
  ...
  render: function() {
    return (
      React.createElement("div", {id: "holdings-table"}, 
        React.createElement("thead", null, 
          React.createElement("tr", {className: "header-row"}, 
            React.createElement("th", {className: "header-column selected ascending"}, "Symbol"), 
            React.createElement("th", {className: "header-column"}, "Name"), 
            React.createElement("th", {className: "header-column"}, "Price"), 
            React.createElement("th", {className: "header-column"}, "Change"), 
            React.createElement("th", {className: "header-column"}, "Quantity"), 
            React.createElement("th", {className: "header-column"}, "Market Value"), 
            React.createElement("th", {className: "header-column"}, "Change"), 
            React.createElement("th", {className: "header-column"}, "Gain Loss"), 
            React.createElement("th", {className: "header-column"})
          )
        ), 
        React.createElement("tbody", null, 
          React.createElement("tr", {className: "row"}, 
            React.createElement("td", {className: "column"}, 
              React.createElement("div", {className: "label"}, "AAPL")
            ), 
            React.createElement("td", {className: "column"}, 
              React.createElement("div", {className: "label"}, "Apple, Inc")
            ), 
            React.createElement("td", {className: "column"}, 
              React.createElement("div", {className: "label"}, "503.19")
            ), 
            React.createElement("td", {className: "column"}, 
              React.createElement("div", {className: "label"}, "+4.03"), 
              React.createElement("div", {className: "label"}, "+0.89%")
            ), 
            React.createElement("td", {className: "column"}, 
              React.createElement("div", {className: "label"}, "21")
            ), 
            React.createElement("td", {className: "column"}, 
              React.createElement("div", {className: "label"}, "4,302.01")
            ), 
            React.createElement("td", {className: "column"}, 
              React.createElement("div", {className: "label"}, "+80.81"), 
              React.createElement("div", {className: "label"}, "+0.89%")
            ), 
            React.createElement("td", {className: "column"}, 
              React.createElement("div", {className: "label"}, "+3,290.12"), 
              React.createElement("div", {className: "label"}, "+249.24%")
            ), 
            React.createElement("td", {className: "column"}, 
  ...
  render: function() {
    return (
      React.createElement("div", {className: "toolbar"}, 
        ...
        React.createElement("div", {className: "trade-button"})
      )
    )
  }
    ...
    return (
      React.createElement("nav", {id: "nav"}, 
        ...
        React.createElement("ul", {className: "menu"}, 
          React.createElement("li", {className: "menu-option"}, "Summary"), 
          React.createElement("li", {className: "menu-option"}, "Banking"), 
          React.createElement("li", {className: "menu-option"}, "Investments"), 
          React.createElement("li", {className: "menu-option"}, "Budgets")
        ), 
...
},{"hbsfy/runtime":41}],31:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":41}],32:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":41}],33:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":41}],34:[function(require,module,exports){
(function (global){
"use strict";
