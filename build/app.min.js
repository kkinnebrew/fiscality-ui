...
var TransactionRow = React.createClass({displayName: "TransactionRow",
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {class: "transaction-row"}, 
        React.createElement(DateField, {value: data.date, onChange: this.handleChange}), 
        React.createElement(SelectField, {value: data.transactionType, onChange: this.handleChange}), 
        React.createElement(TextField, {value: data.description, onChange: this.handleChange}), 
        React.createElement(CurrencyField, {value: data.amount, onChange: this.handleChange}), 
        React.createElement(Label, {value: data.balance})
      )
    )
  }
