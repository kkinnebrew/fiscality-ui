...
},{"../templates/app.hbs":32,"../templates/app/accounts.hbs":33,"../templates/app/accounts/chart.hbs":34,"../templates/app/accounts/overlay.hbs":35,"../templates/app/accounts/transactions.hbs":36,"../templates/app/investments.hbs":37,"../templates/app/investments/activity.hbs":38,"../templates/app/investments/allocation.hbs":39,"../templates/app/investments/overlay.hbs":40,"../templates/app/investments/performance.hbs":41,"../templates/app/investments/positions.hbs":42,"../templates/app/investments/positions/chart.hbs":43,"../templates/app/investments/positions/positions.hbs":44,"../templates/app/menu.hbs":45,"../templates/app/settings.hbs":46,"../templates/home.hbs":47,"../templates/home/forgot.hbs":48,"../templates/home/login.hbs":49,"../templates/home/register.hbs":50,"../templates/home/reset.hbs":51,"./common/cache":2,"./common/router.coffee":5,"./presenters/app/accounts/accounts.coffee":9,"./presenters/app/investments/investments.coffee":10,"./viewmodels/app/accounts/chart.coffee":15,"./viewmodels/app/accounts/overlay.coffee":16,"./viewmodels/app/accounts/transactions.coffee":17,"./viewmodels/app/investments/investments.coffee":18,"./viewmodels/app/investments/overlay.coffee":19,"./viewmodels/app/investments/positions/chart.coffee":20,"./viewmodels/app/investments/positions/positions.coffee":21,"./viewmodels/app/menu.coffee":22,"./viewmodels/home/forgot.coffee":23,"./viewmodels/home/login.coffee":24,"./viewmodels/home/register.coffee":25,"./viewmodels/home/reset.coffee":26,"./views/app/accounts/chart.coffee":27,"./views/app/accounts/overlay.coffee":28,"./views/app/accounts/transactions.coffee":29,"./views/app/investments/overlay.coffee":30,"./views/app/menu.coffee":31,"datejs":"datejs","hbsfy/runtime":59,"jquery":"jquery","jquery-circle-progress":"jquery-circle-progress"}],2:[function(require,module,exports){
var cache = {};
...
Router = (function() {
  ...
  Router.prototype.renderState = function(state, config, depth, params) {
    ...
    if (config.presenter) {
      ...
      _.each(node.views, function(subnode) {
        if (subnode.present) {
          return node.presenter[subnode.present + 'ViewModel'] = subnode.viewmodel;
        }
      });
  ...
  Router.prototype.destroyGlobal = function(name) {
    ...
    node = this.globals[name];
    return node.view.destroy().always(function() {
      node.$el.remove();
...
},{"./log.coffee":3,"./view.coffee":7,"./viewmodel.coffee":8,"jquery":"jquery","underscore":"underscore"}],6:[function(require,module,exports){
var $ = require('jquery');
...
AccountsPresenter = (function(superClass) {
  ...
  function AccountsPresenter(params) {
  ...
  AccountsPresenter.prototype.load = function() {
    ...
    return this.accountsViewModel.on('select', this.selectAccount);
  };
  ...
  AccountsPresenter.prototype.selectAccount = function(accountId) {
    ...
    this.transactionsViewModel.setAccount(accountId);
    this.hideOverlay();
    return this.router.goto('/app/accounts/' + accountId);
  };

  AccountsPresenter.prototype.showOverlay = function() {
    this.chartViewModel.markHidden();
    this.accountsViewModel.overlayed = true;
    return this.router.renderGlobal('accounts');
  };

  AccountsPresenter.prototype.showFullOverlay = function() {
    this.chartViewModel.markHidden();
  ...
  AccountsPresenter.prototype.hideOverlay = function() {
    this.chartViewModel.markVisible();
...
},{"../../../common/presenter.coffee":4}],10:[function(require,module,exports){
...
InvestmentsPresenter = (function(superClass) {
  ...
  function InvestmentsPresenter(params) {
    this.hideOverlay = bind(this.hideOverlay, this);
    this.showFullOverlay = bind(this.showFullOverlay, this);
    this.showOverlay = bind(this.showOverlay, this);
  ...
  InvestmentsPresenter.prototype.selectPortfolio = function(portfolioId) {
    this.investmentsViewModel.setPortfolio(portfolioId);
    this.hideOverlay();
    return this.router.goto('/app/investments/' + portfolioId + '/positions');
  };
  ...
  InvestmentsPresenter.prototype.showFullOverlay = function() {
...
},{"../../../common/presenter.coffee":4}],11:[function(require,module,exports){
...
ChartViewModel = (function(superClass) {
  ...
  ChartViewModel.prototype.update = function() {
    ...
    return $.when(accountRequest, balanceRequest).then((function(_this) {
      ...
      return Log.error('Error loading account for accountId: ' + this.selectedAccountId);
    });
  };
  ...
  ChartViewModel.prototype.markHidden = function() {
    this.isHidden = true;
    return this.fire('refresh');
  };

  ChartViewModel.prototype.markVisible = function() {
    this.isHidden = false;
    return this.fire('refresh');
  };
...
},{"../../../common/cache":2,"../../../common/log.coffee":3,"../../../common/viewmodel.coffee":8,"../../../services/transactions.coffee":14,"jquery":"jquery"}],16:[function(require,module,exports){
...
},{"../../../common/log.coffee":3,"../../../common/viewmodel.coffee":8,"../../../services/transactions.coffee":14}],17:[function(require,module,exports){
...
TransactionsViewModel = (function(superClass) {
  ...
  TransactionsViewModel.prototype.update = function() {
    ...
    return transactionsService.transactions(this.accountId).then((function(_this) {
      return function(data) {
        var balance;
        balance = 0;
...
},{"../../../common/log.coffee":3,"../../../common/viewmodel.coffee":8,"../../../services/transactions.coffee":14,"underscore":"underscore"}],18:[function(require,module,exports){
...
},{"../../../common/log.coffee":3,"../../../common/viewmodel.coffee":8,"../../../services/investments.coffee":13}],19:[function(require,module,exports){
...
},{"../../../common/log.coffee":3,"../../../common/viewmodel.coffee":8,"../../../services/investments.coffee":13}],20:[function(require,module,exports){
module.exports = require('../../../../common/viewmodel.coffee');



},{"../../../../common/viewmodel.coffee":8}],21:[function(require,module,exports){
module.exports = require('../../../../common/viewmodel.coffee');
...
},{"../../common/log.coffee":3,"../../common/viewmodel.coffee":8,"../../services/auth.coffee":11}],24:[function(require,module,exports){
...
},{"../../common/log.coffee":3,"../../common/viewmodel.coffee":8,"../../services/auth.coffee":11}],25:[function(require,module,exports){
...
},{"../../common/log.coffee":3,"../../common/viewmodel.coffee":8,"../../services/auth.coffee":11}],26:[function(require,module,exports){
...
},{"../../common/log.coffee":3,"../../common/viewmodel.coffee":8,"../../services/auth.coffee":11}],27:[function(require,module,exports){
...
},{"../../../common/view.coffee":7,"jquery":"jquery"}],28:[function(require,module,exports){
...
OverlayView = (function(superClass) {
  ...
  OverlayView.prototype.render = function() {
    ...
    return setTimeout((function(_this) {
      return function() {
        return _this.$el.find('#accounts-overlay').addClass('activate');
      };
    })(this), 0);
  };
  ...
  OverlayView.prototype.destroy = function() {
    ...
    this.unbind();
    this.$el.find('#accounts-overlay').removeClass('activate');
...
},{"../../common/view.coffee":7,"jquery":"jquery"}],32:[function(require,module,exports){
...
},{"hbsfy/runtime":59}],33:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":59}],34:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
    return "    <div class=\"chart-container blur\">\n";
},"3":function(depth0,helpers,partials,data) {
    return "    <div class=\"chart-container\">\n";
},"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    var stack1, alias1=this.escapeExpression;

  return ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.isHidden : depth0),{"name":"if","hash":{},"fn":this.program(1, data, 0),"inverse":this.program(3, data, 0),"data":data})) != null ? stack1 : "")
...
},{"hbsfy/runtime":59}],35:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
    return "        <div class=\"accounts-close-btn\" data-bind=\"click:close()\"></div>\n";
},"3":function(depth0,helpers,partials,data) {
    var helper, alias1=helpers.helperMissing, alias2="function", alias3=this.escapeExpression;

  return "                <li class=\"account-list-item\" data-key=\""
...
},{"hbsfy/runtime":59}],36:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":59}],37:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    var stack1;
...
},{"hbsfy/runtime":59}],39:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":59}],40:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
    return "        <div class=\"portfolios-close-btn\" data-bind=\"click:close()\"></div>\n";
},"3":function(depth0,helpers,partials,data) {
    var helper, alias1=helpers.helperMissing, alias2="function", alias3=this.escapeExpression;

  return "                <li class=\"portfolio-list-item\" data-key=\""
...
},{"hbsfy/runtime":59}],41:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":59}],42:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":59}],43:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    var stack1, alias1=this.escapeExpression;
...
},{"hbsfy/runtime":59}],44:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":59}],45:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":59}],46:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":59}],47:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":59}],48:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":59}],49:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":59}],50:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":59}],51:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":59}],52:[function(require,module,exports){
(function (global){
"use strict";
