...
var TransactionEditRow = React.createClass({displayName: "TransactionEditRow",
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "row editing"}, 
        React.createElement("div", {className: "column"}, 
          React.createElement(DateField, {className: "field", value: transaction.date})
        ), 
        React.createElement("div", {className: "column md"}, 
          React.createElement(SelectField, {className: "field", value: transaction.transactionType})
        ), 
        React.createElement("div", {className: "column xl"}, 
          React.createElement(TextField, {className: "field", value: transaction.description}), 
        ...
        React.createElement("div", {className: "column right"}, 
          React.createElement(CurrencyField, {className: "field", value: transaction.amount})
        )
      )
    )
  }
  ...
  render: function() {
    ...
    var transactionRows = this.props.transactions.map(function(transaction) {
      if (transaction.editing) {
        return (
          React.createElement(TransactionEditRow, {transaction: transaction})
        )
      } else {
        return (
          React.createElement(TransactionRow, {transaction: transaction})
        )
      }
    });
