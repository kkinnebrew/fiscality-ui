...
},{"../templates/app.hbs":29,"../templates/app/settings.hbs":30,"../templates/home.hbs":31,"../templates/home/forgot.hbs":32,"../templates/home/login.hbs":33,"../templates/home/register.hbs":34,"../templates/home/reset.hbs":35,"./common/cache":2,"./common/router.coffee":5,"./viewmodels/app1/banking.coffee":13,"./viewmodels/app1/navigation.coffee":14,"./viewmodels/home/forgot.coffee":15,"./viewmodels/home/login.coffee":16,"./viewmodels/home/register.coffee":17,"./viewmodels/home/reset.coffee":18,"./views/app1/banking.jsx":19,"./views/app1/investments.jsx":24,"./views/app1/navigation.jsx":28,"datejs":"datejs","hbsfy/runtime":43,"jquery":"jquery","jquery-circle-progress":"jquery-circle-progress"}],2:[function(require,module,exports){
var cache = {};
...
var $, BankingViewModel, Log, ViewModel, _, numberWithCommas, transactionsService,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
  ...
  BankingViewModel.prototype.update = function() {
    ...
    return $.when(transactionsRequest).then((function(_this) {
      return function(transactions) {
        _this.transactions = _.map(_.sortBy(transactions, 'transactionDate'), map).reverse();
        return _this.fire('refresh', {
...
},{"../../common/viewmodel.coffee":8}],15:[function(require,module,exports){
  ...
  render: function() {
    return (
      React.createElement("div", {id: "banking"}, 
        React.createElement(BankingToolbar, {account: this.state.account, balance: this.state.balance, onClick: this.handleMenuClose}), 
        React.createElement(TransactionTable, {transactions: this.state.transactions}), 
        React.createElement(TransactionDetail, null), 
        React.createElement(AccountsMenu, {ref: "menu", accounts: this.state.accounts, onSelect: this.handleSelect, onClick: this.handleMenuOpen})
      )
    )
  }
...
},{"./banking/menu.jsx":20,"./banking/toolbar.jsx":21,"./banking/transaction-detail.jsx":22,"./banking/transaction-table.jsx":23,"react":"react"}],20:[function(require,module,exports){
var React = require('react');
var $ = require('jquery');
...
var AccountsMenu = React.createClass({displayName: "AccountsMenu",
  ...
  render: function() {
    ...
    var accountRows = this.props.accounts.map(function(account) {
      return (
        React.createElement("div", {className: "item", onClick: that.handleSelect, "data-key": account.accountId}, account.accountName)
      )
    });
...
},{"./investments/chart.jsx":25,"./investments/holdings-table.jsx":26,"./investments/toolbar.jsx":27,"react":"react"}],25:[function(require,module,exports){
var React = require('react');
