...
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<div class=\"editor-line\">\n\n    <div data-component=\"select-field\" data-model=\"accountId\" data-source=\"accounts\">1</div>\n    <div data-component=\"text-field\" data-model=\"amount\">2</div>\n    <div>Delete</div>\n\n</div>";
},"useData":true});
...
},{"../../list-component.coffee":20,"./editor-list.hbs":12}],12:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<div class=\"transaction-list-body\" data-outlet>\n\n</div>";
},"useData":true});
...
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<div class=\"editor\">\n\n    <header>\n        <div data-component=\"date-field\" data-model=\"transactionDate\">Date</div>\n        <div data-component=\"select-field\" data-model=\"transactionType\" data-source=\"transactionTypes\">Type</div>\n        <div data-component=\"text-field\" data-model=\"description\">Description</div>\n        <div data-model=\"amount\">Amount</div>\n    </header>\n\n    <div data-component=\"line-editor\" data-model=\"lines\" data-repeat=\"editor-line\">Lines</div>\n\n</div>";
},"useData":true});

},{"hbsfy/runtime":80}],15:[function(require,module,exports){
var LineEditorComponent, ListComponent, template,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
},{"../../list-component.coffee":20,"./line-editor.hbs":16}],16:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<div class=\"line-editor\">\n\n    <div class=\"lines\" data-outlet></div>\n\n    <div class=\"add-line-button\">Add Line</div>\n\n</div>";
},"useData":true});
...
Component = (function() {
  ...
  Component.prototype.render = function() {
    ...
    this.model = data;
    return this.$el.find('[data-component]').each(function() {
  ...
  Component.prototype.fire = function(event) {
    if (this.events.hasOwnProperty(event)) {
      return _.each(this.events[event], function(callback) {
        return callback.call(this);
      });
    }
  };
...
var $, DateFieldComponent, ValueComponent,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
DateFieldComponent = (function(superClass) {
  ...
  function DateFieldComponent() {
    return DateFieldComponent.__super__.constructor.apply(this, arguments);
  }
...
},{"./value-component.coffee":23,"jquery":"jquery"}],20:[function(require,module,exports){
var $, ListComponent, _, componentFactory;
...
ListComponent = (function() {
  ...
  ListComponent.prototype.render = function() {
    var $template, name, self;
    self = this;
    $template = $(this.getTemplate());
    name = this.$el.attr('data-repeat');
    _.each(this.model, function(line, index) {
      var $el, component;
      $el = $('<div></div>');
      ...
      component.on('change', function() {
        ...
        _.each(self.children, function(child) {
          if (child.index === index && child.component !== component) {
            return child.component.setValue(value);
          }
        });
        return self.fire('change');
      });
      return $template.find('[data-outlet]').append(component.$el);
    });
  ...
  ListComponent.prototype.setValue = function(name, value) {
    this.model[name] = value;
    return _.each(this.children, function(child) {
      if (child.model === name) {
        return child.component.setValue(value);
...
},{"./component-factory.coffee":17,"jquery":"jquery","underscore":"underscore"}],21:[function(require,module,exports){
...
var $, EditorComponent, Log, TransactionEditorComponent, TransactionsView, View, addLineTemplate, addTransactionTemplate, editorTemplate,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
TransactionsView = (function(superClass) {
  ...
  TransactionsView.prototype.render = function() {
    ...
    component = new EditorComponent(this.$el.find('#editor'), {
      transactionId: '123',
      ...
      transactionTypes: ['Deposit', 'Withdrawal', 'Transfer', 'Buy To Open', 'Sell To Close']
    });
    component.render();
    return setInterval(function() {
      return console.log(component.getValue());
    }, 5000);
  };
...
},{"../../../../templates/app/accounts/add-line.hbs":51,"../../../../templates/app/accounts/add-transaction.hbs":52,"../../../../templates/app/accounts/editor.hbs":55,"../../../common/log.coffee":4,"../../../common/view.coffee":7,"../../../components/app/accounts/editor.coffee":13,"jquery":"jquery"}],47:[function(require,module,exports){
var $, OverlayView, View,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "\n"
    + ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.transactions : depth0),{"name":"each","hash":{},"fn":this.program(2, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "\n";
  ...
  return "\n            <div class=\"transaction-group\">\n\n                <div class=\"transaction-editor\">\n\n                    <div class=\"transaction-row list-row\">\n                        <div class=\"list-cell cell-sm\">\n                            <input class=\"field-input\" name=\"transactionDate\" type=\"text\" value=\""
    + this.escapeExpression(((helper = (helper = helpers.currentDate || (depth0 != null ? depth0.currentDate : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0,{"name":"currentDate","hash":{},"data":data}) : helper)))
    + "\" />\n                        </div>\n                        <div class=\"list-cell\">\n                            <select class=\"field-input\" name=\"transactionType\">\n                                <option value=\"Deposit\">Deposit</option>\n                                <option value=\"Buy To Open\">Buy To Open</option>\n                                <option value=\"Sell To Close\">Sell To Close</option>\n                                <option value=\"Transfer\">Transfer</option>\n                            </select>\n                        </div>\n                        <div class=\"list-cell cell-lg\"></div>\n                        <div class=\"list-cell cell-lg\">\n                            <input class=\"field-input\" name=\"description\" type=\"text\" value=\"\" />\n                        </div>\n                        <div class=\"list-cell cell-sm\">0.00</div>\n                        <div class=\"list-cell cell-sm\"></div>\n                    </div>\n\n                    <div class=\"line-row list-row\">\n                        <div class=\"list-cell cell-sm\"></div>\n                        <div class=\"list-cell\"></div>\n                        <div class=\"list-cell cell-lg\">\n                            <select class=\"field-input\" name=\"accountId\">\n"
    + ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.accounts : depth0),{"name":"each","hash":{},"fn":this.program(6, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "                            </select>\n                        </div>\n                        <div class=\"list-cell cell-lg\"></div>\n                        <div class=\"list-cell cell-sm\">\n                            <input class=\"field-input\" name=\"amount\" type=\"text\" value=\"0.00\" />\n                        </div>\n                        <div class=\"list-cell cell-sm\"></div>\n                        <div class=\"row-options\">\n                            <div class=\"row-option delete-row-btn\">Delete</div>\n                        </div>\n                    </div>\n\n                    <div class=\"add-line-row list-row\">\n                        <div class=\"list-cell cell-sm\"></div>\n                        <div class=\"list-cell\"></div>\n                        <div class=\"list-cell cell-lg add-row-btn\">Add Line</div>\n                        <div class=\"list-cell cell-lg\"></div>\n                        <div class=\"list-cell cell-sm\"></div>\n                        <div class=\"list-cell cell-sm\"></div>\n                    </div>\n\n                    <div class=\"editor-options\">\n                        <div class=\"editor-option save-btn\">Save</div>\n                    </div>\n\n                </div>\n\n            </div>\n\n";
  ...
  return "<header id=\"transactions-header\">\n\n    <div class=\"title\">Bank of America Checking</div>\n\n    <div class=\"info\">\n        <div class=\"balance\">$6,302.21</div>\n        <div class=\"updated\">Last Updated May 24, 2015</div>\n    </div>\n\n</header>\n\n<div id=\"transactions-options\">\n\n    <div class=\"date-range\">\n        <input type=\"text\" value=\"Jan 1, 2015\" />\n        to\n        <input type=\"text\" value=\"Dec 31, 2015\" />\n    </div>\n\n    <input class=\"search-field\" type=\"search\" placeholder=\"Search\" />\n\n</div>\n\n<div id=\"transactions-list\">\n\n    <div class=\"transaction-list-header\">\n\n        <div class=\"header-row\">\n            <div class=\"header-cell cell-sm\">Date</div>\n            <div class=\"header-cell\">Transaction Type</div>\n            <div class=\"header-cell cell-lg\">Accounts</div>\n            <div class=\"header-cell cell-lg\">Description</div>\n            <div class=\"header-cell cell-sm\">Amount</div>\n            <div class=\"header-cell cell-sm\">Balance</div>\n        </div>\n\n    </div>\n\n    <div class=\"transaction-list-body\">\n\n        <div id=\"editor\"></div>\n\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.transactions : depth0),{"name":"if","hash":{},"fn":this.program(1, data, 0),"inverse":this.program(5, data, 0),"data":data})) != null ? stack1 : "")
    + "\n    </div>\n\n</div>";
},"useData":true});
