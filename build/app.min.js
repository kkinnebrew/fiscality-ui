...
ListComponent = (function() {
  ...
  ListComponent.prototype.render = function() {
    ...
    this.$appendTo = $template.find('[data-outlet]').length ? $template.find('[data-outlet]') : $template;
    this.repeat = this.$el.attr('data-repeat');
    _.each(this.model, this.append);
    return this.$el = $template.replaceAll(this.$el);
  };

  ListComponent.prototype.append = function(line, index) {
    var component, self;
    self = this;
    component = componentFactory.getInstance(this.repeat, $('<div></div>'), line, this.scope);
    this.children.push({
      $el: component.$el,
      component: component,
      index: index
    ...
    return this.$appendTo.append(component.$el);
  };

  ListComponent.prototype.push = function(model) {
    var count;
    count = model.length;
    this.append(model, count);
    return this.model.push(model);
  };
