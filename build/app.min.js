...
},{"../templates/app.hbs":60,"../templates/app/accounts.hbs":61,"../templates/app/accounts/chart.hbs":62,"../templates/app/accounts/connect.hbs":63,"../templates/app/accounts/overlay.hbs":64,"../templates/app/investments.hbs":65,"../templates/app/investments/activity.hbs":66,"../templates/app/investments/allocation.hbs":67,"../templates/app/investments/overlay.hbs":68,"../templates/app/investments/performance.hbs":69,"../templates/app/investments/positions.hbs":70,"../templates/app/investments/positions/chart.hbs":71,"../templates/app/investments/positions/positions.hbs":72,"../templates/app/menu.hbs":73,"../templates/app/settings.hbs":74,"../templates/home.hbs":75,"../templates/home/forgot.hbs":76,"../templates/home/login.hbs":77,"../templates/home/register.hbs":78,"../templates/home/reset.hbs":79,"./common/cache":2,"./common/router.coffee":7,"./components/app/accounts/editor-line.coffee":11,"./components/app/accounts/editor-list.coffee":13,"./components/app/accounts/editor.coffee":15,"./components/app/accounts/line-editor.coffee":17,"./components/component-factory.coffee":19,"./components/date-field.coffee":21,"./components/hidden-field.coffee":22,"./components/select-field.coffee":24,"./components/text-field.coffee":25,"./controllers/app/accounts/accounts.coffee":27,"./controllers/app/investments/investments.coffee":28,"./viewmodels/app/accounts/chart.coffee":33,"./viewmodels/app/accounts/connect.coffee":34,"./viewmodels/app/accounts/overlay.coffee":35,"./viewmodels/app/accounts/transactions.coffee":36,"./viewmodels/app/investments/investments.coffee":37,"./viewmodels/app/investments/overlay.coffee":38,"./viewmodels/app/investments/positions/chart.coffee":39,"./viewmodels/app/investments/positions/positions.coffee":40,"./viewmodels/app/menu.coffee":41,"./viewmodels/home/forgot.coffee":42,"./viewmodels/home/login.coffee":43,"./viewmodels/home/register.coffee":44,"./viewmodels/home/reset.coffee":45,"./views/app/accounts/chart.coffee":46,"./views/app/accounts/connect.coffee":47,"./views/app/accounts/overlay.coffee":48,"./views/app/accounts/transactions.jsx":49,"./views/app/investments/overlay.coffee":58,"./views/app/menu.coffee":59,"datejs":"datejs","hbsfy/runtime":87,"jquery":"jquery","jquery-circle-progress":"jquery-circle-progress"}],2:[function(require,module,exports){
var cache = {};
...
ReactView = (function() {
  ...
  ReactView.prototype.refresh = function() {
    if (!this.rendered) {
...
},{"./log.coffee":4,"jquery":"jquery","react":"react","underscore":"underscore"}],7:[function(require,module,exports){
...
},{"./log.coffee":4,"./react-view.coffee":6,"./view.coffee":9,"./viewmodel.coffee":10,"jquery":"jquery","underscore":"underscore"}],8:[function(require,module,exports){
var $ = require('jquery');
...
},{"./log.coffee":4,"jquery":"jquery","underscore":"underscore"}],10:[function(require,module,exports){
var Log, ViewModel, _;
...
},{"./log.coffee":4,"underscore":"underscore"}],11:[function(require,module,exports){
...
EditorListComponent = (function(superClass) {
  ...
  EditorListComponent.prototype.render = function() {
    EditorListComponent.__super__.render.apply(this, arguments);
    return this.$el.on('click', '.add-transaction-btn', (function(_this) {
      return function() {
        return _this.append({});
      };
    })(this));
...
},{"../../list-component1.coffee":23,"./editor-list.hbs":14}],14:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<div class=\"content\">\n\n    <div class=\"add-transaction-btn\">Add Transaction</div>\n\n    <div data-outlet></div>\n\n</div>";
},"useData":true});

},{"hbsfy/runtime":87}],15:[function(require,module,exports){
var Component, EditorComponent, _, template,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
EditorComponent = (function(superClass) {
  ...
  function EditorComponent() {
    EditorComponent.__super__.constructor.apply(this, arguments);
  ...
  EditorComponent.prototype.render = function() {
    ...
    this.$el.find('.save-subrow').hide();
    this.$el.on('click', '[data-model="accountNames"]', (function(_this) {
      return function() {
    ...
    this.$el.on('click', '.save-btn', (function(_this) {
      return function() {
        if (_this.model.transactionId) {
          _this.scope.saveTransaction(_this.model.transactionId, {
            transactionType: _this.model.transactionType,
            transactionDate: _this.model.transactionDate,
            description: _this.model.description,
            lines: _.map(_this.model.otherLines, function(line) {
              return {
        ...
        _this.original = JSON.parse(JSON.stringify(_this.model));
        return _this.$el.find('.save-subrow').hide();
      };
    })(this));
    return this.$el.on('click', '.cancel-btn', (function(_this) {
      return function() {
        _this.setValue(JSON.parse(JSON.stringify(_this.original)));
        return _this.$el.find('.save-subrow').hide();
      };
    })(this));
  };
  ...
  EditorComponent.prototype.onChange = function() {
    this.changed = true;
    return this.$el.find('.save-subrow').show();
  };
...
},{"../../list-component1.coffee":23,"./line-editor.hbs":18,"underscore":"underscore"}],18:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
Component = (function() {
  ...
  Component.prototype.render = function() {
    ...
    this.$el.find('[data-component]').each(function() {
      ...
      return self.model[model] = component.getValue();
    });
    return this.$el.find('[data-model]:not([data-component])').each(function() {
      var $el, defaultVal, model, tagName;
      $el = $(this);
      model = $el.attr('data-model');
      defaultVal = $el.attr('data-default');
      tagName = $el.prop('tagName');
      if (tagName === 'DIV' && self.model[model]) {
  ...
  Component.prototype.onChange = function() {};
  ...
  Component.prototype._setProperty = function(name, value) {
  ...
  Component.prototype.setValue = function(values) {
    return _.each(values, (function(_this) {
      return function(value, name) {
        return _this._setProperty(name, value);
      };
    })(this));
  };
...
},{"./component-factory.coffee":19,"jquery":"jquery","underscore":"underscore"}],21:[function(require,module,exports){
...
},{"./value-component.coffee":26,"jquery":"jquery","underscore":"underscore"}],22:[function(require,module,exports){
var $, HiddenFieldComponent, ValueComponent,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
HiddenFieldComponent = (function(superClass) {
  extend(HiddenFieldComponent, superClass);

  function HiddenFieldComponent() {
    return HiddenFieldComponent.__super__.constructor.apply(this, arguments);
  }

  HiddenFieldComponent.prototype.getTemplate = function() {
...
},{"./value-component.coffee":26,"jquery":"jquery"}],23:[function(require,module,exports){
...
ListComponent = (function() {
  ...
  ListComponent.prototype.setValue = function(value) {
    console.log('set value', value);
    this.children = [];
    this.$outlet.empty();
    this.model = value;
    return _.each(this.model, (function(_this) {
      return function(item) {
        var component;
        component = _this._generate(item);
        return _this.$outlet.append(component.$el);
...
},{"../common/log.coffee":4,"./component-factory.coffee":19,"jquery":"jquery","underscore":"underscore"}],24:[function(require,module,exports){
...
SelectFieldComponent = (function(superClass) {
  ...
  SelectFieldComponent.prototype.render = function() {
    SelectFieldComponent.__super__.render.apply(this, arguments);
    if (!this.model) {
      console.log(this.$el.find('option:first').val());
      this.model = this.$el.find('option:first').val();
      return this.fire('change');
    }
  };
...
},{"./value-component.coffee":26,"jquery":"jquery","underscore":"underscore"}],25:[function(require,module,exports){
...
},{"./value-component.coffee":26,"jquery":"jquery"}],26:[function(require,module,exports){
var $, Log, ValueComponent, _;
...
},{"../common/log.coffee":4,"jquery":"jquery","underscore":"underscore"}],27:[function(require,module,exports){
...
},{"../../../common/controller.coffee":3}],28:[function(require,module,exports){
...
},{"../../../common/controller.coffee":3}],29:[function(require,module,exports){
...
},{"../common/cache":2,"../common/service":8,"./config":30,"./investments.coffee":31,"./transactions.coffee":32,"jquery":"jquery"}],30:[function(require,module,exports){
module.exports = {
  BASE_URL: {
...
},{"../common/cache":2,"../common/service":8,"./config":30,"jquery":"jquery","underscore":"underscore"}],32:[function(require,module,exports){
...
},{"../common/cache":2,"../common/service":8,"./config":30,"jquery":"jquery","underscore":"underscore"}],33:[function(require,module,exports){
...
},{"../../../common/cache":2,"../../../common/log.coffee":4,"../../../common/viewmodel.coffee":10,"../../../services/transactions.coffee":32,"jquery":"jquery"}],34:[function(require,module,exports){
...
},{"../../../common/log.coffee":4,"../../../common/viewmodel.coffee":10,"../../../services/transactions.coffee":32}],35:[function(require,module,exports){
...
},{"../../../common/log.coffee":4,"../../../common/viewmodel.coffee":10,"../../../services/transactions.coffee":32}],36:[function(require,module,exports){
...
TransactionsViewModel = (function(superClass) {
  ...
  TransactionsViewModel.prototype.addTransaction = function(data) {
    var direction, line, lines, request, sum;
    direction = this.account.accountType === 'Asset' || this.account.accountType === 'Expense' ? 1 : -1;
    lines = [];
    sum = 0;
    _.each(data.lines, function(data) {
      var amount, line;
      ...
      if (amount > 0 && direction === 1) {
        line.debitAmount = (direction = 1) ? 0 : amount;
        line.creditAmount = (direction = 1) ? amount : 0;
      } else {
        line.debitAmount = (direction = 1) ? Math.abs(amount) : 0;
        line.creditAmount = (direction = 1) ? 0 : Math.abs(amount);
      }
  ...
  TransactionsViewModel.prototype.update = function() {
    var accountsRequest, that, transactionsRequest;
    if (!this.accountId) {
      return;
    }
    this.startLoading();
    ...
    return $.when(transactionsRequest, accountsRequest).then((function(_this) {
      return function(data, accounts) {
        var balance;
        balance = 0;
        _this.accounts = _.sortBy(_.filter(accounts, function(account) {
          return account.accountId !== that.accountId;
        }), 'accountName');
        _this.account = _.find(accounts, function(account) {
          return account.accountId === that.accountId;
        });
...
},{"../../../common/log.coffee":4,"../../../common/viewmodel.coffee":10,"../../../services/transactions.coffee":32,"jquery":"jquery","underscore":"underscore"}],37:[function(require,module,exports){
...
},{"../../../common/log.coffee":4,"../../../common/viewmodel.coffee":10,"../../../services/investments.coffee":31}],38:[function(require,module,exports){
...
},{"../../../common/log.coffee":4,"../../../common/viewmodel.coffee":10,"../../../services/investments.coffee":31}],39:[function(require,module,exports){
module.exports = require('../../../../common/viewmodel.coffee');



},{"../../../../common/viewmodel.coffee":10}],40:[function(require,module,exports){
module.exports = require('../../../../common/viewmodel.coffee');



},{"../../../../common/viewmodel.coffee":10}],41:[function(require,module,exports){
...
},{"../../common/viewmodel.coffee":10}],42:[function(require,module,exports){
...
},{"../../common/log.coffee":4,"../../common/viewmodel.coffee":10,"../../services/auth.coffee":29}],43:[function(require,module,exports){
...
},{"../../common/log.coffee":4,"../../common/viewmodel.coffee":10,"../../services/auth.coffee":29}],44:[function(require,module,exports){
...
},{"../../common/log.coffee":4,"../../common/viewmodel.coffee":10,"../../services/auth.coffee":29}],45:[function(require,module,exports){
...
},{"../../common/log.coffee":4,"../../common/viewmodel.coffee":10,"../../services/auth.coffee":29}],46:[function(require,module,exports){
...
},{"../../../common/view.coffee":9,"jquery":"jquery"}],47:[function(require,module,exports){
...
},{"../../../common/view.coffee":9,"jquery":"jquery"}],48:[function(require,module,exports){
...
},{"../../../common/view.coffee":9,"jquery":"jquery"}],49:[function(require,module,exports){
...
var TransactionsView = React.createClass({displayName: "TransactionsView",
  ...
  render: function() {
    ...
    return (
      React.createElement("div", null, 
        React.createElement(TransactionsHeader, {onSort: this.handleSort, sort: this.state.sort, direction: this.state.direction}), 
        React.createElement(TransactionsBody, {data: this.state.data})
      )
    )
...
},{"../../../common/react-mixin.js":5,"./transactions/transactions-body.jsx":56,"./transactions/transactions-header.jsx":57,"react":"react","underscore":"underscore"}],50:[function(require,module,exports){
var React = require('react');
...
var CurrencyField = React.createClass({displayName: "CurrencyField",
  ...
  render: function() {
    ...
    return React.createElement("input", {className: this.props.className, type: "text", value: value, onChange: this.handleChange});
  }
...
var TransactionRow = React.createClass({displayName: "TransactionRow",
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "transaction-row"}, 
        React.createElement(DateField, {className: "column", value: data.date, onChange: this.handleChange}), 
        React.createElement(SelectField, {className: "column", value: data.transactionType, onChange: this.handleChange}), 
        React.createElement(TextField, {className: "column", value: data.description, onChange: this.handleChange}), 
        React.createElement(CurrencyField, {className: "column", value: data.amount, onChange: this.handleChange}), 
        React.createElement(Label, {className: "column", value: data.balance})
      )
    )
  }
...
},{"./currency-field.jsx":50,"./date-field.jsx":51,"./label.jsx":52,"./select-field.jsx":53,"./text-field.jsx":54,"react":"react"}],56:[function(require,module,exports){
var React = require('react');
...
var TransactionsTable = React.createClass({displayName: "TransactionsTable",
  ...
  render: function() {
    ...
    var transactionRows = this.props.data.map(function(transaction) {
      return (
        React.createElement(TransactionRow, {data: transaction})
      )
    });

    return (
      React.createElement("div", {className: "transaction-table"}, 
          transactionRows
      )
    )
...
},{"./transaction-row.jsx":55,"react":"react","underscore":"underscore"}],57:[function(require,module,exports){
var React = require('react');
var $ = require('jquery');
var _ = require('underscore');
    ...
    var cells = _.map(columns, function(label, column) {
      ...
      if (that.props.sort == column) {
        if (that.props.direction == 'desc') {
          return React.createElement("div", {className: "column active desc", onClick: that.handleClick, "data-column": column}, label);
        } else {

          return React.createElement("div", {className: "column active asc", onClick: that.handleClick, "data-column": column}, label);
        }
      } else {
        return React.createElement("div", {className: "column", onClick: that.handleClick, "data-column": column}, label);
      }
...
},{"jquery":"jquery","react":"react","underscore":"underscore"}],58:[function(require,module,exports){
var $, OverlayView, View,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
},{"../../../common/view.coffee":9,"jquery":"jquery"}],59:[function(require,module,exports){
var $, MenuView, View,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
},{"../../common/view.coffee":9,"jquery":"jquery"}],60:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":87}],61:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":87}],62:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
...
},{"hbsfy/runtime":87}],63:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":87}],64:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":87}],65:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    var stack1, alias1=this.escapeExpression;
...
},{"hbsfy/runtime":87}],66:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":87}],67:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":87}],68:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
    return "        <div class=\"close-btn\" data-bind=\"click:close()\"></div>\n";
...
},{"hbsfy/runtime":87}],69:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":87}],70:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":87}],71:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    var stack1, alias1=this.escapeExpression;
...
},{"hbsfy/runtime":87}],72:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":87}],73:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":87}],74:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":87}],75:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":87}],76:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":87}],77:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":87}],78:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":87}],79:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":87}],80:[function(require,module,exports){
(function (global){
"use strict";
