    ...
    _.each(config.views, (function(_this) {
      return function(conf, name) {
        ...
        if (name.match(/@/)) {
          ...
          return Log.debug('Rendering absolute state: ' + state + ' -> ' + name);
        }
      };
    })(this));
    if (config.presenter) {
      return node.presenter = new config.presenter(params);
    }
  };
...
},{"../../common/view":3,"jquery":"jquery"}],25:[function(require,module,exports){
