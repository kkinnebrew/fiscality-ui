...
},{"../templates/app.hbs":38,"../templates/home.hbs":39,"../templates/home/forgot.hbs":40,"../templates/home/login.hbs":41,"../templates/home/register.hbs":42,"../templates/home/reset.hbs":43,"./common/cache":2,"./common/router.coffee":5,"./viewmodels/app/banking.coffee":13,"./viewmodels/app/investments.coffee":14,"./viewmodels/app/navigation.coffee":15,"./viewmodels/home/forgot.coffee":16,"./viewmodels/home/login.coffee":17,"./viewmodels/home/register.coffee":18,"./viewmodels/home/reset.coffee":19,"./views/app/banking.jsx":20,"./views/app/investments.jsx":32,"./views/app/navigation.jsx":37,"datejs":"datejs","hbsfy/runtime":51,"jquery":"jquery","jquery-circle-progress":"jquery-circle-progress"}],2:[function(require,module,exports){
var cache = {};
...
BankingViewModel = (function(superClass) {
  ...
  BankingViewModel.prototype.createAccount = function(account) {
    return transactionsService.createAccount(account.accountName, account.accountType).then((function(_this) {
      return function(data) {
        console.log(data);
  ...
  render: function() {
    return (
      React.createElement("div", {id: "banking"}, 
        ...
        React.createElement(AccountsMenu, {ref: "menu", key: "accounts", accounts: this.state.accounts, onCreate: this.handleCreate, onSelect: this.handleSelect, onClick: this.handleMenuOpen})
      )
    )
  }
    ...
    return (
      React.createElement("div", {id: "accounts-menu"}, 
        ...
        React.createElement("div", {className: "header"}, 
          ...
          React.createElement("div", {className: "add-account-button", ref: "add", onClick: this.handleNew}, "New")
        ), 

        React.createElement("div", {id: "create-account-form", className: "section", ref: "create"}, 
          React.createElement("div", {className: "title"}, "Create Account"), 
          React.createElement("input", {type: "text", className: "field", ref: "accountName", placeholder: "Account Name"}), 
          React.createElement("select", {className: "field", ref: "accountType"}, 
            React.createElement("option", null, "Asset"), 
            React.createElement("option", null, "Liability"), 
            React.createElement("option", null, "Income"), 
            React.createElement("option", null, "Expense"), 
            React.createElement("option", null, "Equity")
          ), 
          React.createElement("div", {className: "create-button", onClick: this.handleCreate}, "Create")
        ), 
...
var TransactionEditRow = React.createClass({displayName: "TransactionEditRow",
  ...
  render: function() {
    ...
    if (!transaction.transactionId) {
      ...
      amountSelector = React.createElement(CurrencyField, {className: "field", ref: "amount", value: transaction.amount});
    } else {
      amountSelector = React.createElement("div", {className: "label", ref: "amount"}, transaction.amount)
    }
    return (
...
},{"hbsfy/runtime":51}],44:[function(require,module,exports){
(function (global){
"use strict";
